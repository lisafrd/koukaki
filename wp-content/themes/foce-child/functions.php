...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'swiper-bundle-js', get_stylesheet_directory_uri() . '/swiper-bundle.min.css');
    wp_enqueue_script('swiper-bundle', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js', array('jquery'), null, true);
    wp_enqueue_script('jquery', 'https://code.jquery.com/jquery-3.6.4.min.js', array('jquery'), null, true);
